...
public interface ICpCodeMgr extends Com4jObject {
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_MARKET_KIND
   */

  @DISPID(12) //= 0xc. The runtime will prefer the VTID if present
  @VTID(18)
  cp.util.CPE_MARKET_KIND getStockMarketKind(
    java.lang.String bstrCode);
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_CONTROL_KIND
   */

  @DISPID(13) //= 0xd. The runtime will prefer the VTID if present
  @VTID(19)
  cp.util.CPE_CONTROL_KIND getStockControlKind(
    java.lang.String bstrCode);
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_SUPERVISION_KIND
   */

  @DISPID(14) //= 0xe. The runtime will prefer the VTID if present
  @VTID(20)
  cp.util.CPE_SUPERVISION_KIND getStockSupervisionKind(
    java.lang.String bstrCode);
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_CAPITAL_SIZE
   */

  @DISPID(15) //= 0xf. The runtime will prefer the VTID if present
  @VTID(21)
  cp.util.CPE_CAPITAL_SIZE getStockCapital(
    java.lang.String bstrCode);
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_KOSPI200_KIND
   */

  @DISPID(18) //= 0x12. The runtime will prefer the VTID if present
  @VTID(24)
  cp.util.CPE_KOSPI200_KIND getStockKospi200Kind(
    java.lang.String bstrCode);
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_STOCK_STATUS_KIND
   */

  @DISPID(28) //= 0x1c. The runtime will prefer the VTID if present
  @VTID(25)
  cp.util.CPE_STOCK_STATUS_KIND getStockStatusKind(
    java.lang.String bstrCode);
   ...
   * </p>
   * @param marketKind Mandatory cp.util.CPE_MARKET_KIND parameter.
   * @return  Returns a value of type java.lang.Object
   */
  ...
  java.lang.Object getStockListByMarket(
    cp.util.CPE_MARKET_KIND marketKind);
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_KSE_SECTION_KIND
   */

  @DISPID(30) //= 0x1e. The runtime will prefer the VTID if present
  @VTID(36)
  cp.util.CPE_KSE_SECTION_KIND getStockSectionKind(
    java.lang.String bstrCode);
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_LAC_KIND
   */

  @DISPID(31) //= 0x1f. The runtime will prefer the VTID if present
  @VTID(37)
  cp.util.CPE_LAC_KIND getStockLacKind(
    java.lang.String bstrCode);
   ...
   * </p>
   * @param bstrName Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_ECT_PARPRICE_CHANGE
   */

  @DISPID(42) //= 0x2a. The runtime will prefer the VTID if present
  @VTID(48)
  cp.util.CPE_ECT_PARPRICE_CHANGE getStockParPriceChageType(
    java.lang.String bstrName);
   ...
   * </p>
   * @param bstrName Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_ECT_VENTURE_KIND
   */

  @DISPID(44) //= 0x2c. The runtime will prefer the VTID if present
  @VTID(50)
  cp.util.CPE_ECT_VENTURE_KIND getVentureKind(
    java.lang.String bstrName);
   ...
   * </p>
   * @param bstrCode Mandatory java.lang.String parameter.
   * @return  Returns a value of type cp.util.CPE_ECT_OVERHEAT
   */

  @DISPID(72) //= 0x48. The runtime will prefer the VTID if present
  @VTID(78)
  cp.util.CPE_ECT_OVERHEAT getOverHeating(
    java.lang.String bstrCode);
