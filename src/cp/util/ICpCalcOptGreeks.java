...
public interface ICpCalcOptGreeks extends Com4jObject {
   ...
   * </p>
   * @param rhs Mandatory cp.util.CALLPUT_TYPE parameter.
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(7)
  void callPutType(
    cp.util.CALLPUT_TYPE rhs);
   ...
   * </p>
   * @param rhs Mandatory cp.util.VOLATILITY_TYPE parameter.
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(11)
  void volatilityType(
    cp.util.VOLATILITY_TYPE rhs);
